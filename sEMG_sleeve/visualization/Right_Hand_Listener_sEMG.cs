...
public class Right_Hand_Listener_sEMG : MonoBehaviour
{
    [Header("Network Settings")]
    public int port = 5016;  // Predicted sEMG hand stream arrives on 5016
    ...
    void Start()
    {
        ...
        Debug.Log($"Right Hand sEMG Listener started on port {port}");
    }
    ...
    void OnApplicationQuit()
    {
        ...
        Debug.Log("Right Hand sEMG Listener stopped");
    }
